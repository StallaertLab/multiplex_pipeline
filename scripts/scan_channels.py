...
from multiplex_pipeline.core_preparation.channel_scanner import discover_channels
...
def parse_args():
    ...
    parser.add_argument("--config-dir", help="Path to Globus config directory (if using Globus)")
