...
def parse_args():
    ...
    parser.add_argument("--overwrite", action="store_true", help="Should the masks be overwritten.")
...
def main():
    ...
    # define controller 
    segmentation_controller = SegmentationController(segmenter, cleaner = cleaner, resolution_level = settings['segmentation']['resolution_level'], overwrite_mask = args.overwrite)
